...
sudo cp "$SOURCE_DIR/app-ads.txt" "$DEST_DIR/"
...
sudo chmod 644 "$DEST_DIR/app-ads.txt"
...
echo "✅ Deployed files:"
ls -la "$DEST_DIR"/*.html "$DEST_DIR"/*.css "$DEST_DIR"/*.js "$DEST_DIR"/robots.txt "$DEST_DIR"/app-ads.txt 2>/dev/null
echo ""
